	...
	return (
		<div>
			<Head>
				...
				{/* @ts-ignore */}
				<link rel="preload" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css" as="style" media="all" onLoad="this.onload=null;this.rel='stylesheet'" />
				{/* jQuery library */}
				...
				{/* Google font Roboto */}
				{/* @ts-ignore */}
				<link rel="preload" href="https://fonts.googleapis.com/css?family=Roboto:400,700&display=swap" as="style" media="all" onLoad="this.onload=null;this.rel='stylesheet'" />
